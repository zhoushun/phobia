...
static void reg_proc_PWM(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    int irq;
...
static void reg_proc_ADC(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    int irq;
...
#ifdef HW_HAVE_NETWORK_EPCAN
static void reg_proc_CAN_bitfreq(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_CAN_errate(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_CAN_epfreq(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_CAN_offset(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_CAN_ID(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_CAN_timeout(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_DPS(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_PPM(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_STEP(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_DRV_partno(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_DRV_status(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        DRV_status();
        hal_memory_fence();
...
static void reg_proc_DRV_configure(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->i = reg->link->i;
    } else if (rval != NULL) {
...
static void reg_proc_CNT_diag_us(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_CNT_diag_pc(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_task(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    int reg_ID;
...
static void reg_proc_dc_threshold(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_ppm_freq(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_rpm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_mmps(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    rval_t rpm;
...
static void reg_proc_kmh(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    rval_t rpm;
...
static void reg_proc_rpm_pc(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
...
static void reg_proc_voltage(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_current_pc(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        if (reg->link->f > 0.f) {
...
static void reg_proc_torque_pc(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float mQ;
...
static void reg_proc_knob(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (pm.config_LU_DRIVE == PM_DRIVE_CURRENT) {
        ...
        if (lval != NULL) lval->f = 0.f;
    }
}

static void reg_proc_lambda_kv(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
...
static void reg_proc_lambda_nm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float mQ;
...
static void reg_proc_lambda_rw(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    rval_t Kt;
...
static void reg_proc_kgm2(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
...
static void reg_proc_kg(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    const float Zq = (float)(pm.const_Zp * pm.const_Zp);
...
static void reg_proc_load_nm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_auto_maximal_current(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_auto_probe_speed_hold(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_auto_forced_maximal(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_auto_forced_accel(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_auto_zone_threshold(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_voltage_tol(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float halt_U, tol_U;
...
static void reg_proc_current_tol(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float halt_A, tol_A;
...
static void reg_proc_current_halt(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float halt_A;
...
static void reg_proc_percent(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_weakening(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    float weak;
    ...
    if (lval != NULL) {
        ...
        if (pm.const_im_Ld > M_EPSILON && rval->f > 100.f) {
...
static void reg_proc_auto_loop_current(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f * 100.f;
    } else if (rval != NULL) {
...
static void reg_proc_auto_loop_speed(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f * 100.f;
    } else if (rval != NULL) {
...
static void reg_proc_wattage(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f;
    } else if (rval != NULL) {
...
static void reg_proc_fpos_nolock_deg(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
...
static void reg_proc_location_deg(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_location_mm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f * (pm.const_Sm * 1000.f) / (M_2_PI_F * (float)pm.const_Zp);
    } else if (rval != NULL) {
        if (pm.const_Sm > M_EPSILON) {
            reg->link->f = rval->f * (M_2_PI_F * (float)pm.const_Zp) / (pm.const_Sm * 1000.f);
        }
    }
}

static void reg_proc_km(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_mm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = reg->link->f * 1000.f;
    } else if (rval != NULL) {
...
static void reg_proc_x_accel(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
...
static void reg_proc_x_accel_mm(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    rval_t accel;

    if (lval != NULL) {
        reg_proc_x_accel(reg, &accel, NULL);
        lval->f = accel.f * (pm.const_Sm * 1000.f) / (M_2_PI_F * (float)pm.const_Zp);
    } else if (rval != NULL) {
        if (pm.const_Sm > M_EPSILON) {
            accel.f = rval->f * (M_2_PI_F * (float)pm.const_Zp) / (pm.const_Sm * 1000.f);
            reg_proc_x_accel(reg, NULL, &accel);
        }
    }
}

static void reg_proc_watt_fuel(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    int irq;
...
static void reg_proc_tlm_rate(const reg_t *reg, rval_t *lval, const rval_t *rval)
{
    if (lval != NULL) {
        lval->f = hal.PWM_frequency / (float)reg->link->i;
    } else if (rval != NULL) {
        ...
        if (rval->f <= hal.PWM_frequency && rval->f >= 0.1f)
...
#ifdef HW_HAVE_DRV_ON_PCB
static void reg_format_DRV_gate_current(const reg_t *reg, const rval_t *rval)
{
    float current = DRV_gate_current();
    printf("%0i (%3f A)", rval->i, &current);
}

static void reg_format_DRV_ocp_level(const reg_t *reg, const rval_t *rval)
{
...
static void reg_format_self_BST(const reg_t *reg, const rval_t *rval)
{
    const int *BST = (const int *) &reg->link->i;
    printf("%1f %1f %1f (ms)", &BST[0], &BST[1], &BST[2]);
}

static void reg_format_self_IST(const reg_t *reg, const rval_t *rval)
{
...
static void reg_format_self_RMSi(const reg_t *reg, const rval_t *rval)
{
    const float *RMS = (const float *) &reg->link->f;
    printf("%3f %3f %3f (A)", &RMS[0], &RMS[1], &RMS[2]);
}

static void reg_format_self_RMSt(const reg_t *reg, const rval_t *rval)
{
    const float *RMS = (const float *) &reg->link->f;
    printf("%4f %4f %4f (V)", &RMS[0], &RMS[1], &RMS[2]);
}

static void reg_format_referenced(const reg_t *reg, const rval_t *rval, int reg_ID)
{
    const char *fmt, *su;
...
#ifdef HW_HAVE_NETWORK_EPCAN
static void reg_format_ref_net_ep0(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_NET_EP0_REG_ID);
}

static void reg_format_ref_net_ep1(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_NET_EP1_REG_ID);
}

static void reg_format_ref_net_ep2(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_NET_EP2_REG_ID);
}

static void reg_format_ref_net_ep3(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_NET_EP3_REG_ID);
}
#endif /* HW_HAVE_NETWORK_EPCAN */

static void reg_format_ref_ppm(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_AP_PPM_REG_ID);
}

#ifdef HW_HAVE_STEP_DIR_KNOB
static void reg_format_ref_step(const reg_t *reg, const rval_t *rval)
{
...
static void reg_format_ref_knob(const reg_t *reg, const rval_t *rval)
{
    reg_format_referenced(reg, rval, ID_AP_KNOB_REG_ID);
}
#endif /* HW_HAVE_ANALOG_KNOB */

static void reg_format_ref_auto(const reg_t *reg, const rval_t *rval)
{
...
static int reg_format_textual(const reg_t *reg, const rval_t *rval)
{
...
static void reg_format_enum(const reg_t *reg, const rval_t *rval)
{
...
static void reg_getval(const reg_t *reg, rval_t *lval)
{
    if (reg->proc != NULL) {
...
static void reg_setval(const reg_t *reg, const rval_t *rval)
{
...
SH_DEF(reg)
{
    ...
    if (reg != NULL) {
        ...
        if (reg->fmt[2] == 'i') {
            ...
            if (htoi(&rval.i, s) != NULL) reg_setval(reg, &rval);
        } else {
            if (stof(&rval.f, s) != NULL) reg_setval(reg, &rval);
        }

        reg_format(reg);
    } else {
        for (reg = regfile; reg->sym != NULL; ++reg) {
            if (strstr(reg->sym, s) != NULL && (reg->mode & REG_HIDDEN) == 0)
                reg_format(reg);
        }
    }
}
...
SH_DEF(enum_reg)
{
    ...
    if (reg != NULL && reg->fmt[2] == 'i'
        ...
        for (rval.i = 0; rval.i < 40; ++rval.i) {
            printf("%2i [%-3i] %s = ", reg->mode | REG_HIDDEN, reg_ID, reg->sym);
