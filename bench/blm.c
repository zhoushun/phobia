...
static void blm_equation(const blm_t *m, const double state[7], double y[7])
{
...
static void blm_ode_step(blm_t *m, double dT)
{
...
static void blm_solve(blm_t *m, double dT)
{
    double iA, iB, iC;
...
static double blm_ADC(double vconv, double vmin, double vmax)
{
    double rel;
    int ADC;
...
static void blm_sample_hall(blm_t *m)
{
    double mX, mY, hX, hY;
    int HS = 0;
...
static void blm_sample_eabi(blm_t *m)
{
...
static void blm_sample_analog(blm_t *m)
{
    double location, angle;
...
static void blm_pwm_bsort(blm_t *m)
{
    int ebuf[2], i;
...
static void blm_pwm_up_event(blm_t *m, int ev)
{
    switch (ev) {
    case 1:
...
static void blm_pwm_down_event(blm_t *m, int ev)
{
    switch (ev) {
    case 0:
...
static void blm_pwm_solve(blm_t *m)
{
    double dTu;
